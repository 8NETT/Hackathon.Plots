...
public sealed class CadastrarTalhao : BaseUseCase<CadastrarTalhaoDTO, TalhaoDTO>, ICadastrarTalhaoUseCase
{
    public CadastrarTalhao(IUnitOfWork unitOfWork, IValidator<CadastrarTalhaoDTO>? validator, ILogger logger)
